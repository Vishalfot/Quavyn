...
const ANALYSTS = [
  { id: "business", name: "Business Analyst AI", icon: Briefcase, status: "Analysing 340 records", color: "violet" },
  { id: "financial", name: "Financial Analyst AI", icon: DollarSign, status: "Projecting Q3 revenue", color: "emerald" },
  { id: "market", name: "Market Analyst AI", icon: LineChart, status: "Monitoring 12 competitors", color: "blue" },
  { id: "risk", name: "Risk Analyst AI", icon: ShieldAlert, status: "Evaluating regulatory impact", color: "rose" },
  { id: "strategy", name: "Strategy Analyst AI", icon: Target, status: "Synthesizing convergence", color: "amber" },
];
